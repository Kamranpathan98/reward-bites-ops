 ...
 * Gate 5 (menu catalog) + Gate 6 (orders) routes. `/t/*` `/o/*` (public QR
 * ordering) don't exist yet — that's Gate 11. `/app/counter` (the fuller
 * table-grid + menu-picker order-taking floor view) is a later polish
 * pass — Gate 6's `/app/orders` covers list/create/detail/transition/
 * cancel/reopen, which is everything this gate's task brief asks for.
 */
